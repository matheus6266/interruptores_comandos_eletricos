...
corrente_rms_2 = sqrt((ciclo_trabalho_2*(corrente_ib_2^2 + 
...
print(
  paste(
    "A potência dissipada em condução do diodo será:",potencia_conducao_2,"W."));
...
print(
  paste(
    "A temperatura de junção do diodo será:",
    round(temperatura_juncao_2,2),"ºC."));
...
resistencia_da_2 <- calculo_resistencia_da(resistencia_ja_projeto_2,
...
print(
  paste(
    "O valor de resistência máxima do dissipador do projeto deve ser:",round(resistencia_da_2,2),"ohms.Considerando o valor de resistência do dissapador de calor de",round(resistencia_da_final_2,2),"ohms o valor final da resistência Rja final será:",round(resistencia_ja_projeto_final_2,2),"ohms"));
...
print(paste("Após a instalação do dissipador de calor modelo: WA-T220-101E a 
temperatura da junção ficou em:",round(temperatura_juncao_final_2,2),"ºC"));
